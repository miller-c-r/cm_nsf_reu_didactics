...
## Intro Social Control {.scrollable}
...
## Methods Inventories {.scrollable}

-   **Inventories**
    -   Measures of psychopathic traits Grandiose-Manipulative, Callous-Unemotional, Daring-Impulsive, Antisocial Process Screening Device (APSD) and Inventoryof Callous-Unemotional Traits (ICU) questionnaires. 
        -   APSD
...
a.  Findings partially supported hypotheses. There were significant interaction effects of neighborhood social processes and resting HR on psychopathic traits and antisocial behavior, however the effects were different in boys and girls and across the various outcomes.
b.  Higher social cohesion was associated with higher GM traits, but only in boys with higher HR. Higher social control was associated with lower CU traits, but only in girls with lower resting HR.
c.  Interestingly, while we found that boys with higher HR and girls with lower HR had higher aggression when social control was lower, we also found that for boys with lower HR and girls with higher HR, the opposite pattern was observed, where higher aggression was associated with higher social control. Finally, we also found that lower social control was associated with higher delinquency in girls with lower HR.
d.  Neighborhood social processes are distinctly associated with the three dimensions of childhood psychopathy and with conduct problems in children with a specific psychophysiological profile.
e.  These relationships are further differentiated by sex
...
Nakhaie, M. R., Silverman, R. A., & LaGrange, T. C. (2000). Selfcontrol
and social control: An examination of gender, ethnicity,
class, and delinquency. The Canadian Journal of Sociology, 25(1),
35–59
