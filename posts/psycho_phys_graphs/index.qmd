...
hist(scores_and_vitals$`Child Z Score`, xlim = c(-3, 4), breaks = seq(from= -3, to=4, by=0.25), ylim = c(0, 70), main= "Histogram of Child Z Scores", xlab = "z transformed aggression scores", ylab = "Frequency", las=1, col="blue")
...
hist(scores_and_vitals$`Parent Z Score`, xlim = c(-3, 4), breaks = seq(from= -3, to=4, by=0.25), ylim = c(0, 70), main= "Histogram of Parent Z Scores", xlab = "z transformed aggression scores", ylab = "Frequency", las=1, col="darkslategray4")
...
ggplot(tri_heart_rate, mapping = aes(`Trichotomized Heart Rate`, `Mean Discontinuity Score`, fill= `Trichotomized Heart Rate`))+
 ...
 # geom_line(aes(`Standard Deviation`, `Mean Discontinuity Score`))+
  ...
  geom_hline(yintercept = -.02, linetype = "1F", size=1, alpha=0.8,  color = "blue")+
  geom_hline(yintercept = 0.15, linetype = "1F",  alpha=0.8,color = "red")+
  geom_hline(yintercept = -0.18, linetype = "1F", alpha=0.8,color = "green")+
    theme_classic() 
