...
![](tachometer_boas.jpg){.absolute top="50" left="200" width="500" height="400"}
![](rear_tachometer.jpg){.absolute bottom="50" right="200" width="500" height="200"}
...
The polyvagal perspective relates autonomic nervous system (ANS) function to behavior.
This perspective includes the ANS, neural circuits involved in the regulation of autonomic state, and an interpretation of autonomic reactivity as adaptive
